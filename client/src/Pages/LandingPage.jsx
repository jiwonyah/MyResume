...
const LandingPage = () => {
  return (
    <div className="max-w-5xl mx-auto mt-20 px-4 sm:px-6 lg:px-8">
      ...
      {/* About Me Section */}
      <section className="bg-[#887257] p-8 sm:p-16">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
          <div className="relative bg-white rounded-3xl p-5 w-full lg:w-[600px]">
            ...
            <h2 className="text-3xl font-black mb-5 text-center mt-16 sm:mt-20">ABOUT ME</h2>
          ...
          <div className="w-full lg:w-[400px] mt-8 lg:mt-32">
            <p className="text-lg sm:text-xl font-light text-white">I am <strong>Jiwon Moon</strong>, a developer focused on implementing user-friendly features and interfaces.</p>
            <p className="text-lg sm:text-xl font-light text-white mt-4">I prioritize closely analyzing the characteristics of target users and catering to their needs.</p>
          </div>
        </div>
      </section>
              ...
              <div key={index} className="bg-white rounded-3xl p-6 sm:p-8 w-full lg:w-[600px]">
                ...
                <ul className="list-disc pl-8">
                  {item.description.map((desc, i) => (
                    <li key={i} className="text-lg sm:text-xl mb-2 mx-2 sm:mx-6">{desc}</li>
                  ))}
                </ul>
              </div>
            ))}
      ...
      <section className="bg-white p-8 sm:p-12 lg:p-16">
        ...
        <div className="flex items-center justify-center mb-12">
          ...
          <div className="bg-cover bg-center rounded-3xl p-6 sm:p-10" style={{backgroundImage: `url(${note})`}}>
